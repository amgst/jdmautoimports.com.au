...
export default function Cars() {
  ...
  return (
    <>
      <SEO
        title="JDM Auto Imports - Premium Car Rentals"
        description="JDM Auto Imports offers premium JDM and luxury car rentals in Australia. Choose from our exclusive fleet of Japanese imports and high-performance vehicles."
      />
